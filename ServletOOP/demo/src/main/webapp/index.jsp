...
<body>
    <div class="container">
        ...
        <div class="student-section">
            <form name="student_registration" action="/demo/api/students/register" method="post">
            ...
            <form action="/demo/api/students/print" method="get">
                <div class="form-group">
            ...
            <!-- Print All Students -->
            <form action="/demo/api/students/printAll" method="get">
                <div class="button-group">
        ...
        <div class="teacher-section">
            ...
            <form action="/demo/api/teachers/print" method="get">
                <div class="form-group">
            ...
            <form action="/demo/api/teachers/printAll" method="get">
                <div class="button-group">
